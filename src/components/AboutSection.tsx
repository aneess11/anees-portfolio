  ...
  return (
    ...
    >
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="pointer-events-none absolute top-[4%] left-[1%] sm:left-[2%] md:left-[4%] w-[60px] sm:w-[160px] md:w-[210px] hidden sm:block"
      >
        <img
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="pointer-events-none absolute bottom-[8%] left-[3%] sm:left-[6%] md:left-[10%] w-[55px] sm:w-[140px] md:w-[180px] hidden sm:block"
      >
        <img
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="pointer-events-none absolute top-[4%] right-[1%] sm:right-[2%] md:right-[4%] w-[60px] sm:w-[160px] md:w-[210px] hidden sm:block"
      >
        <img
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="pointer-events-none absolute bottom-[8%] right-[3%] sm:right-[6%] md:right-[10%] w-[65px] sm:w-[170px] md:w-[220px] hidden sm:block"
      >
        <img
          ...
          <FadeIn delay={0.15} className="w-full max-w-3xl">
            <div className="flex flex-col gap-5 sm:gap-6">
              {[
                {
                  label: 'Languages',
                  items: ['Python', 'Bash Scripting', 'MySQL'],
                },
                {
                  label: 'Frameworks & Libraries',
                  items: ['React', 'Tailwind', 'Pandas', 'NumPy', 'Scikit-learn', 'PyTorch'],
                },
                {
                  label: 'AI & AI Agents',
